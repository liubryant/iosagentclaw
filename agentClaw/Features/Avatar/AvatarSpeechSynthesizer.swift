...
final class AvatarSpeechSynthesizer: NSObject, AVSpeechSynthesizerDelegate {
    ...
    private weak var activeDigitalHuman: DuixDigitalHumanController?
    ...
    func speak(
        _ text: String,
        digitalHuman: DuixDigitalHumanController? = nil,
        ...
        if let digitalHuman = digitalHuman, digitalHuman.canDriveSpeech {
            ...
            self.onStart?()
            driveDigitalHuman(with: text, digitalHuman: digitalHuman, generation: currentGeneration)
    ...
    private func driveDigitalHuman(with text: String, digitalHuman: DuixDigitalHumanController, generation: Int) {
        let pcmUtterance = makeUtterance(text)
