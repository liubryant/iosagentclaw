...
final class DuixDigitalHumanController: ObservableObject {
    static let shared = DuixDigitalHumanController()
    ...
    func attach(to view: UIView) {
        ...
        guard let paths = DuixResourceLocator.lilyPaths() else {
            updateState(.unavailable("缺少 Lily 或基础模型资源"))
            return
        }
